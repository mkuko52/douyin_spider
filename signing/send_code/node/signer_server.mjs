...
const DTRAIT_OPTS = {
  dTraitPath: ['/passport/web/send_code/'],
...
const TARGET_URL = 'https://login.douyin.com/passport/web/send_code/';
...
const BDMS_PATHS = ["^/webcast/", "^/aweme/v1/", "^/aweme/v2/", "/douplus/", "^/api/ad/v1/inspire", "/v1/message/send", "^/live/", "^/captcha/", "^/ecom/", "^/luna/pc", "/passport/web/send_code/", "/passport/web/sms_login/", "/passport/web/get_qrcode/"];
  ...
  await sb.evaluate(`(function(){
    ...
    setTimeout(function(){
      try {
        ...
        var pptBdms = { paths: ['/passport/web/send_code/','/passport/web/sms_login/','/passport/web/get_qrcode/'] };
...
async function handle(req) {
  switch (req.cmd) {
    ...
    case 'abogus': {
      ...
      const url = req.url
        || ('https://login.douyin.com/passport/web/send_code/?' + String(req.query || ''));
